...
Foreach ($ComputerName in $AllComputersNames) {
   ...
   $ComputerInfo | Add-Member -MemberType NoteProperty -Name "TPMPresent" -Value $ComputerInfoTPMPresent -Force
   $ComputerInfo | Add-Member -MemberType NoteProperty -Name "TPM 2.0" -Value $ComputerInfoTPMP20 -Force
   $ComputerInfo | Add-Member -MemberType NoteProperty -Name "Processor Compatible" -Value $ComputerInfoProcessorCompatible -Force
   ...
   if ($Connection -eq "True"){
      ...
      $ComputerInfoTPMPresent = [bool](Get-Tpm).tpmpresent
      ...
      $ComputerInfoProcessorCompatible = [bool]$Proc
...
$Inventory | Export-Csv C:\TechResources\Inventory.csv